...
function MidCareerServicePage({ content, showFallbackNotice, fallbackNotice }) {
...
MidCareerServicePage.propTypes = {
...
MidCareerServicePage.getLayout = function getLayout(page) {
...
export async function getStaticProps({ locale = 'en-GB' }) {
  ...
  const { content, isFallback } = getServicesPageContent('mid-career', resolvedLocale);
...
export default MidCareerServicePage;
