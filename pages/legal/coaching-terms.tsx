...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  return { props: { locale: resolved, title: zh ? 'Coaching 條款' : 'Coaching Terms', summary: zh ? '正式合作前會以書面確認的核心商務安排。' : 'Core commercial arrangements confirmed in writing before paid work begins.', sections: zh ? [
    { title: '服務', paragraphs: ['英國與亞洲跨境領導 Coaching 計畫包含六次 60 分鐘一對一線上會談，通常在 12-16 週內完成。SustainSage 閱讀合作詢問後，會在任何承諾前以書面提供服務範圍、費用與條款。'] },
    ...
    { title: 'Service', paragraphs: ['The UK-Asia Cross-Border Leadership Coaching Programme includes six 60-minute one-to-one online sessions, normally over 12-16 weeks. After reviewing an enquiry, SustainSage provides the scope, fee and terms in writing before any commitment.'] },
