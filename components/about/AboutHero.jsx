...
export default function AboutHero({ hero = {}, showFallbackNotice = false, fallbackNotice = null }) {
  ...
  return (
    <PageSection id="about-hero" eyebrow={hero?.eyebrow} title={hero?.title} lead={hero?.lead}>
