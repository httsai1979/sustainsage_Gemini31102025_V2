...
export default function CookieConsent({ consent, onConsent }) {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-50 flex flex-col gap-4 rounded-2xl border border-sustain-cardBorder bg-sustain-cardBg p-5 shadow-lg md:inset-x-auto md:bottom-6 md:right-6 md:max-w-sm">
      <div>
        <p className="text-sm font-semibold text-sustain-textMain">We use cookies for analytics</p>
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <button
          ...
          className="inline-flex flex-1 items-center justify-center rounded-xl bg-sustain-primary px-4 py-2 text-sm font-semibold text-white transition hover:bg-sustain-primarySoft"
        >
          Accept
        </button>
        <button
          ...
          className="inline-flex flex-1 items-center justify-center rounded-xl border border-sustain-cardBorder px-4 py-2 text-sm font-semibold text-sustain-textMain transition hover:bg-sustain-primary/10"
        >
          Decline
        </button>
      </div>
