...
const parseResourceItem = (resourceEntry) => {
  ...
  return {
    ...
    type: resourceEntry.fields.type,
    category: resourceEntry.fields.category || null,
    ...
    summary: resourceEntry.fields.summary || '',
    image: resourceEntry.fields.coverImage?.fields?.file?.url
      ? `https:${resourceEntry.fields.coverImage.fields.file.url}`
      : null,
  };
};
